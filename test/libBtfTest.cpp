...
TEST_CASE("Logging", "[libhelper]")
{
    ...
    std::string should_be = "Trace [file: test\\libBtfTest.cpp: 1039 `____C_A_T_C_H____T_E_S_T____44`] This is a trace message\n"
                            "Warning [file: test\\libBtfTest.cpp: 1040 `____C_A_T_C_H____T_E_S_T____44`] This is a warning message\n"
                            "Error [file: test\\libBtfTest.cpp: 1041 `____C_A_T_C_H____T_E_S_T____44`] This is an error message\n";
